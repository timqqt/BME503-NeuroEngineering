...
E_ampa = 0*mV
alpha_ampa = 5/(mM*ms) # due to T's unit is 1
beta_ampa = 0.18/ms

# Equations
# eqs_GABAb='''
# I_gaba_b = g_gaba_b*(s_4**4/(s_4**4+K_d))*(v-E_gaba_b)
# ds4/dt = K_3*r-K_4*s_4
# dr/dt = alpha_gabab*Trpre*(1-r)-beta_gabab*r
# '''

eqs_GABAb='''
I_gaba_b = g_gaba_b_m*(s**4/(s**4+K_d))*(v-E_gaba_b) : amp/meter**2
ds/dt = K_3*r-K_4*s
dr/dt = alpha_gabab*Trpre*(1-r)-beta_gabab*r
g_gaba_b = g_gaba_b_m*s : siemens/meter**2
