...
duration = 100
delta_show = 1
outbugx = np.zeros(int(duration / delta_show))
outbugy = np.zeros(int(duration / delta_show))
outbugang = np.zeros(int(duration / delta_show))
outfoodx = np.zeros(int(duration / delta_show))
outfoody = np.zeros(int(duration / delta_show))
outsrx = np.zeros(int(duration / delta_show))
outsry = np.zeros(int(duration / delta_show))
outslx = np.zeros(int(duration / delta_show))
outsly = np.zeros(int(duration / delta_show))
...
sl_plot = plot([0], [0], 'w')
title("Time: "+str(delta_show*step)+"ms")
pause(0.1)
...
@network_operation(dt=delta_show * ms)
def update_plot(t):
